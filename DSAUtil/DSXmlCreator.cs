...
namespace FISCA.DSAUtil
{
    ...
    public class DSXmlCreator
    {
        ...
        public DSXmlCreator(bool doFormating)
        {
        ...
        public Stream GetResultAsStream()
        {
            if (!IsCompleted)
                CompleteCreateXml();
        ...
        public XPathDocument GetResultAsXPathDocument()
        {
            if (!IsCompleted)
                CompleteCreateXml();

            XPathDocument xpathdoc = new XPathDocument(GetResultAsStream());
            return xpathdoc;
        }

        public DSXmlHelper GetResultAsDSXmlHelper()
        {
            if (!IsCompleted)
                CompleteCreateXml();

            return new DSXmlHelper(GetResultAsXmlDocument());
        }

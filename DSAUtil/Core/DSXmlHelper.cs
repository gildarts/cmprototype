...
namespace FISCA.DSAUtil
{
    ...
    /// </summary>
    public class DSXmlHelper : XmlBaseObject
    {
        /// <summary>
        ...
        public DSXmlHelper()
        {
            BaseNode = DSXmlHelper.LoadXml("<Content/>");
        }
        ...
        public DSXmlHelper(XmlDocument xmlDoc)
        {
            if (xmlDoc == null)
        ...
        public DSXmlHelper(XmlElement element)
        {
            if (element == null)
        ...
        public DSXmlHelper(string rootName)
        {
            BaseNode = DSXmlHelper.LoadXml("<" + rootName + "/>");
        }
